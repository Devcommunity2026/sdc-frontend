...
const ApplicationCard = ({ application, curr }) => {
    ...
    return (
        <div className="w-full p-6 border-b border-border dark:border-dark-border bg-card dark:bg-dark-card hover:bg-secondary/40
         dark:hover:bg-dark-secondary/40 transition-all duration-300">
            <div className="flex flex-col xl:flex-row gap-6">
                ...
                <div className="flex-1 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center gap-3 text-sm text-muted-foreground dark:text-dark-muted-foreground">
                            <Mail size={18} />
                    ...
                    <div>
                        ...
                        <p className="text-sm leading-relaxed rounded-2xl p-4 bg-background dark:bg-dark-background border border-border dark:border-dark-border text-muted-foreground dark:text-dark-muted-foreground">
                ...
                <div className="w-full xl:w-[260px] flex flex-col gap-3">
                    ...
                    <a
                        ...
                        className="flex items-center gap-3 p-4 rounded-2xl bg-background dark:bg-dark-background border border-border dark:border-dark-border hover:bg-secondary dark:hover:bg-dark-secondary transition-all duration-200"
                    >
            ...
            {/* ================= ACTION BUTTONS ================= */}
            <div className="mt-6 pt-6 border-t border-border dark:border-dark-border flex flex-wrap gap-3">
