...
import { Calendar, Clock, User, X, BookOpen } from "lucide-react";
        ...
        {activeBlog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto bg-black/75 backdrop-blur-md">
            ...
            <motion.div
              ...
              className="
                relative w-full max-w-4xl bg-card text-card-foreground dark:bg-dark-card dark:text-dark-card-foreground
                rounded-3xl border border-border dark:border-dark-border shadow-2xl overflow-hidden
            ...
            >
              ...
              <button
                ...
                className="
                  ...
                  bg-black/50 hover:bg-black/75 text-white transition-all border border-white/10 cursor-pointer
                "
