...
import { fetchUsers, handleRoleChange, handleBanUser, handleDeleteContent } from "../../controllers/admin/contentDashboard";
import {
    Shield,
    ShieldCheck,
    Ban,
    ...
    const handleAddMember = async () => {
        ...
        try {
            ...
            if (curr === "Events") {
                ...
                await axios.post(
                    "http://localhost:3000/edit/addEvent",
                    data,
                    {
            ...
            // ================= PROJECTS =================
                ...
                await axios.post(
                    "http://localhost:3000/edit/addProject",
                    data,
                    {
                        withCredentials: true,
                        headers: {
